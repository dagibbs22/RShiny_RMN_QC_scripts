...
#   data.import.avg.monthyear <- summaryBy(myParam ~ myName.SiteID + month, data=data.import, FUN=mean, na.rm=TRUE)
#   head(data.import.avg.monthyear)
#   
#   
#   DVmean <- summaryBy(myParam ~ myName.SiteID, data=data.import, FUN=c(mean))
#   
#   
