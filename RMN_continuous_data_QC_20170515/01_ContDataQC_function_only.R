...
QCtest <- function(Operation.Input
                   ,SiteID.input
                   ,Type.Input
                   ,Start.Input
                   ,End.Input
...
myData.Operation    <- Selection.Operation[Operation.Input]  #number corresponds to intended operation in the line above
#
# PROMPT; Site ID
# single site;         "ECO66G12"
# group of sites;      c("test2", "HRCC", "PBCC", "ECO66G12", "ECO66G20", "ECO68C20", "01187300")
#myData.SiteID       <- "ECO66G12"
myData.SiteID       <- SiteID.input
#
# PROMPT; Data Type
# Type of data file
...
myData.Type         <- Selection.Type[Type.Input] #number corresponds to intended operation in the line above
#
# PROMPT; Start Date
# YYYY-MM-DD ("-" delimiter), leave blank for all data ("1900-01-01")
#myData.DateRange.Start  <- "2013-01-01"
myData.DateRange.Start  <- Start.Input
#
# PROMPT; End Date
# YYYY-MM-DD ("-" delimiter), leave blank for all data (today)
#myData.DateRange.End    <- "2014-12-31"
myData.DateRange.End    <- End.Input 
#
######################################################################
